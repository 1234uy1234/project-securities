...
echo "🚀 KHỞI ĐỘNG NAMED TUNNEL - URL CỐ ĐỊNH"
echo "======================================="
...
# Khởi động Named Tunnel
echo "🌐 Khởi động Named Tunnel..."
cd /Users/maybe/Documents/shopee
cloudflared tunnel run shopee-app &
CLOUDFLARED_PID=$!
sleep 5
...
echo "🌍 Named Tunnel: Đang khởi động..."
echo ""
echo "📱 URL CỐ ĐỊNH SẼ HIỂN THỊ Ở TRÊN!"
